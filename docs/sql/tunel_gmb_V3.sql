...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2018 a las 08:13:40
...
(1, '2018-02-12', 'CODTUR001', 'CODSEN001', '34.000000', '34.000000', '334.000000', 'raul', '2018-02-12 23:22:49', NULL, NULL);
...
(1, 'REGINC', 'REGISTRO DE INCIDENTES', 5);
...
INSERT INTO `operacion` (`id`, `codigo`, `fecha`, `sentido_codigo`, `turno_codigo`, `incidente_codigo`, `coordinador`, `operador1`, `operador2`, `ti`, `epi`, `seguridad`, `movil`, `observaciones`, `flagdelete`, `fregistro`, `usercreate`, `frupdate`, `userupdate`) VALUES
(1, 1, '2018-02-15', 'CODSEN002', 'CODTUR003', 'CODINC001', 'CODPER003', 'CODPER011', 'CODPER012', 'CODPER013', 'CODPER031', 'CODPER035', 'CODVEH003', 'ESTE ES UN COMENTARIO DE PRUEBA', 0, '2018-02-14 23:40:46', 'raul', '0000-00-00 00:00:00', ''),
(5, 2, '2018-02-15', 'CODSEN001', 'CODTUR002', 'CODINC012', 'CODPER002', 'CODPER011', 'CODPER011', 'CODPER016', '0', '0', '0', '', 0, '2018-02-15 00:04:49', 'raul', '0000-00-00 00:00:00', ''),
(6, 3, '2018-02-15', 'CODSEN001', 'CODTUR002', 'CODINC012', 'CODPER002', 'CODPER011', 'CODPER011', 'CODPER016', '0', '0', '0', '', 0, '2018-02-15 00:05:29', 'raul', '0000-00-00 00:00:00', ''),
(7, 4, '2018-02-18', 'CODSEN001', 'CODTUR001', 'CODINC007', 'CODPER002', 'CODPER011', 'CODPER011', 'CODPER015', 'CODPER030', '0', '0', '', 0, '2018-02-18 14:38:55', 'raul', '0000-00-00 00:00:00', ''),
(8, 5, '2018-02-18', 'CODSEN002', 'CODTUR002', 'CODINC016', 'CODPER002', 'CODPER011', 'CODPER011', 'CODPER014', '0', '0', '0', '', 0, '2018-02-18 14:49:34', 'raul', '0000-00-00 00:00:00', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `operacion_archivo`
--

CREATE TABLE `operacion_archivo` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `operacion_archivo`
--

INSERT INTO `operacion_archivo` (`id`, `codigo_operacion`, `nombre`, `ruta`, `tipo`, `size`, `flagdelete`, `fecha_creacion`) VALUES
(8, 1, 'descarga.jpg', '18-02-2018-00-41-11-1-descarga.jpg', 'jpg', '6721', 0, '2018-02-18 05:41:11'),
(9, 1, 'mov_bbb.mp4', '20-02-2018-02-12-22-1-mov_bbb.mp4', 'mp4', '788493', 0, '2018-02-20 07:12:22');
...
CREATE TABLE `operacion_detalle` (
  `id` int(11) NOT NULL,
  `codigo_operacion` int(11) NOT NULL,
  `sistema_codigo` varchar(9) NOT NULL,
  `tipo_equipo_codigo` varchar(9) NOT NULL,
  `equipo_codigo` varchar(9) NOT NULL,
  `acciones_codigo` varchar(9) NOT NULL,
...
--
-- Volcado de datos para la tabla `operacion_detalle`
--

INSERT INTO `operacion_detalle` (`id`, `codigo_operacion`, `sistema_codigo`, `tipo_equipo_codigo`, `equipo_codigo`, `acciones_codigo`, `hora_inicio`, `fecha_inicio`, `hora_fin`, `fecha_fin`, `flagdelete`, `fecha_creacion`) VALUES
(7, 1, 'CODSIS005', 'CODTEQ002', 'CODEQU053', 'CODACC002', '01:09:00', '2018-02-20', '01:09:00', '2018-02-20', 0, '2018-02-20 06:09:20'),
(8, 1, 'CODSIS005', 'CODTEQ002', 'CODEQU050', 'CODACC002', '02:28:00', '2018-02-20', '03:28:00', '2018-02-21', 0, '2018-02-20 06:28:27');
...
--
-- Indices de la tabla `operacion_archivo`
--
ALTER TABLE `operacion_archivo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `operacion_archivo`
--
ALTER TABLE `operacion_archivo`
